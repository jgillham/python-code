...
def adjacentSpots(nodeNum):
    nodeList = []
    for i in range(len(links)): #return list of nodes adjacent
        if links[i][0]==nodes[nodeNum][0] and links[i][1]==nodes[nodeNum][1]:
            nodelist.append((links[i][2],links[i][3]))

        elif links[i][1]==nodes[nodeNum][0] and links[i][0]==nodes[nodeNum][1]:
            nodelist.append((links[i][2],links[i][3]))

        elif links[i][2]==nodes[nodeNum][0] and links[i][3]==nodes[nodeNum][1]:
            nodelist.append((links[i][0],links[i][1]))

        elif links[i][3]==nodes[nodeNum][0] and links[i][2]==nodes[nodeNum][1]:
            nodelist.append((links[i][0],links[i][1]))
    return nodeList
